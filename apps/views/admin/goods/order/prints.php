...
<table width="792px" border="1" cellpadding="0" >
    ...
    <tr class="b">
        <td colspan="3">订单编号：<?php echo $item['order_no'];?></td>
        <td colspan="2">交易单号：<?php echo $item['transaction_id'];?></td>
        <td colspan="1">付款方式：微信支付</td>
    </tr>
    <tr class="b">
        <td colspan="3">收货地址：<?php echo $item['a_address'];?></td>
        <td colspan="2">买家：<?php echo $item['nickname'];?></td>
        <td colspan="1">收货人：<?php echo $item['a_name'];?></td>
    </tr>
    <tr class="b">
        <td colspan="3">订单备注：</td>
        <td colspan="2">联系电话：<?php echo $item['a_mobile'];?></td>
        <td colspan="1"></td>
    </tr>
    <tr class="a">
        <td class="td1">序号</td>
    ...
    <tr class="a">
        ...
        <td><?php echo $v['sku_opt'];?></td>
        <td><?php echo $v['price'];?></td>
        <td><?php echo bcmul($v['num'],$v['price'],2);?></td>
    </tr>
    <?php } ?>
    <tr class="a">
        <td class="num" colspan="2">合计</td>
        <td bgcolor="yellow"><?php echo array_sum(array_column($child,'num'));?></td>
        <td></td>
        <td></td>
        <td bgcolor="yellow"><?php echo $item['total'];?></td>
    </tr>
    <tr>
