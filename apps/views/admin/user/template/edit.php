            ...
            <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <?php echo admin_btn("data[thumb]",'upload','thumb',$item['thumb'],1);?><div class="thumb-say">只能上传一张图片（300px * 300px）</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">产品轮播</label>
                        <div class="layui-input-block">
                            <?php echo admin_btn("data[thumb_arr]",'upload','thumb_arr',$item['thumb_arr'],10);?><div class="thumb-say">可上传多张（640px * 400px）</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="data[integral]" class="layui-input" value="<?php echo $item['integral'];?>" lay-verify='required'>
                            </div>
                        </div>
                        <div class="layui-inline">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="data[ficti]" class="layui-input" value="<?php echo $item['ficti'];?>"  lay-verify='required'>
                            </div>
                        </div>
                        <div class="layui-inline">
