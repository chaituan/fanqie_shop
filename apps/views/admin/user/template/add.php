        ...
        <div class="layui-tab-content" >
            <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <?php echo admin_btn("data[thumb]",'upload','thumbs','',1);?><div class="thumb-say">只能上传一张图片（300px * 300px）</div>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">产品轮播</label>
                    <div class="layui-input-block">
                        <?php echo admin_btn("data[thumb_arr]",'upload','thumb_arr','',10);?><div class="thumb-say">可上传多张（640px * 400px）</div>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="data[ficti]" class="layui-input" value="0"  lay-verify='required'>
                        </div>
                    </div>
                    <div class="layui-inline">
