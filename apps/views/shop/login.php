...
<div class="fanqie-main layui-layout animated shake fanqie-delay2" id="fanqie_login" >
	<div class="avatar" style="display: none;"><img src="<?php echo IMG_PATH.'admin/adminloginlogo.png'?>" class="logo-img"></div>
	<p class="info">商家后台登录</p>
	<div class="user-info">
		<form class="layui-form" id="fanqie_form" method="post">
			 <div class="layui-form-item">
			 	  <input type="text" name="username"  class="layui-input fanqie-input" lay-verify='required' autocomplete="off" maxlength="11" placeholder="请输入帐号">
			 </div>
			 ...
			 <div class="layui-form-item">
			 	 <button class="layui-btn fanqie-btn layui-btn-radius f_ajax" lay-submit lay-filter='sub' url="<?php echo site_url("shop/login/add")?>" location="<?php echo site_url("shop/manager/index")?>" >立即登录</button>
			 </div>
		</form>
	</div>
	<div class="copy-right" style="display: none;">© 2016 - <?php echo format_time(time(),'Y')?> &nbsp;&nbsp; <a href="http://www.chaituans.com/" target="_blank"><?php echo COMPANY;?></a></div>
</div>
