            ...
            <div class="layui-tab-content" >
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <?php echo admin_btn("data[thumb]",'upload','thumb',$item['thumb'],1,'',$shop_id);?><div class="thumb-say">只能上传一张图片（300px * 300px）</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">产品轮播</label>
                        <div class="layui-input-block">
                            <?php echo admin_btn("data[thumb_arr]",'upload','thumb_arr',$item['thumb_arr'],10,'',$shop_id);?><div class="thumb-say">可上传多张（640px * 400px）</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">产品视频</label>
                        <div class="layui-input-block">
                            <?php echo admin_btn("data[video]",'upload','video',$item['video'],1,1,$shop_id);?><div class="thumb-say">只支持mp4格式</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                ...
                <div class="layui-tab-item">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <?php echo admin_btn("data[hb_img]",'upload','hb_img',$item['hb_img'],1,true,$shop_id);?><div class="thumb-say">只能上传一张图片（750px * 1334px）</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
